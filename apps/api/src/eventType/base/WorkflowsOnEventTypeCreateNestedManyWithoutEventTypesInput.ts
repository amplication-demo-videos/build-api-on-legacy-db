...
@InputType()
class WorkflowsOnEventTypeCreateNestedManyWithoutEventTypesInput {
...
export { WorkflowsOnEventTypeCreateNestedManyWithoutEventTypesInput as WorkflowsOnEventTypeCreateNestedManyWithoutEventTypesInput };
