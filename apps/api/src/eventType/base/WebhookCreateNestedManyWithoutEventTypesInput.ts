...
@InputType()
class WebhookCreateNestedManyWithoutEventTypesInput {
...
export { WebhookCreateNestedManyWithoutEventTypesInput as WebhookCreateNestedManyWithoutEventTypesInput };
