...
@InputType()
class EventTypeCustomInputCreateNestedManyWithoutEventTypesInput {
...
export { EventTypeCustomInputCreateNestedManyWithoutEventTypesInput as EventTypeCustomInputCreateNestedManyWithoutEventTypesInput };
