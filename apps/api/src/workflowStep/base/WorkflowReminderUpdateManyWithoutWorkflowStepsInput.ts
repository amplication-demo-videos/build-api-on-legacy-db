...
@InputType()
class WorkflowReminderUpdateManyWithoutWorkflowStepsInput {
...
export { WorkflowReminderUpdateManyWithoutWorkflowStepsInput as WorkflowReminderUpdateManyWithoutWorkflowStepsInput };
