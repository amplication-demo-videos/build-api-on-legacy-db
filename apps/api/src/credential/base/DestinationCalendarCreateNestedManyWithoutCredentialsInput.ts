...
@InputType()
class DestinationCalendarCreateNestedManyWithoutCredentialsInput {
...
export { DestinationCalendarCreateNestedManyWithoutCredentialsInput as DestinationCalendarCreateNestedManyWithoutCredentialsInput };
