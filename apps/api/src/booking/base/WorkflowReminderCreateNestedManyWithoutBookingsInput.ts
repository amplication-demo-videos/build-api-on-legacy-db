...
@InputType()
class WorkflowReminderCreateNestedManyWithoutBookingsInput {
...
export { WorkflowReminderCreateNestedManyWithoutBookingsInput as WorkflowReminderCreateNestedManyWithoutBookingsInput };
